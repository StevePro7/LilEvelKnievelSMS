...
S:Lover_screen.printGameOver$tiles$1_0$147({2}DG,SC:U),R,0,0,[c,b]
S:Lover_screen.printGameOver$x$1_0$147({1}SC:U),R,0,0,[]
S:Lover_screen.printGameOver$y$1_0$147({1}SC:U),R,0,0,[]
S:Lover_screen.printGameOver$d$1_0$147({1}SC:U),R,0,0,[]
F:G$screen_over_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lover_screen.screen_over_screen_load$po$1_0$148({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lover_screen.screen_over_screen_load$lo$1_0$148({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lover_screen.screen_over_screen_load$go$1_0$148({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lover_screen.screen_over_screen_load$player_loadY$1_0$148({1}SC:U),R,0,0,[a]
S:Lover_screen.screen_over_screen_load$checkScreen$1_0$148({1}SC:U),B,1,-1
S:Lover_screen.screen_over_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_over_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lover_screen.screen_over_screen_update$screen_type$1_0$149({2}DG,SC:U),B,1,4
S:Lover_screen.screen_over_screen_update$index$1_0$150({1}SC:U),R,0,0,[]
...
T:Fover_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_check$0_0$0({2}SI:U),Z,0,0)({7}S:S$check_width$0_0$0({1}SC:U),Z,0,0)({8}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
S:G$go$0_0$0({2}DG,STtag_struct_game_object:S),E,0,0
...
S:Fover_screen$printGameOver$0_0$0({2}DF,SV:S),C,0,0
