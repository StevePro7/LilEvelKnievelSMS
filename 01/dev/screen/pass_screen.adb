...
S:Lpass_screen.screen_pass_screen_load$go$1_0$156({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lpass_screen.screen_pass_screen_load$co$1_0$156({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Lpass_screen.screen_pass_screen_load$po$1_0$156({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lpass_screen.screen_pass_screen_load$game_world$1_0$156({1}SC:U),R,0,0,[c]
S:Lpass_screen.screen_pass_screen_load$game_round$1_0$156({1}SC:U),R,0,0,[b]
S:Lpass_screen.screen_pass_screen_load$game_point$1_0$156({1}SC:U),R,0,0,[e]
S:Lpass_screen.screen_pass_screen_load$game_level$1_0$156({1}SC:U),R,0,0,[]
F:G$screen_pass_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lpass_screen.screen_pass_screen_update$screen_type$1_0$159({2}DG,SC:U),B,1,4
S:Lpass_screen.screen_pass_screen_update$po$1_0$160({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lpass_screen.screen_pass_screen_update$go$1_0$160({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lpass_screen.screen_pass_screen_update$sloc0$0_1$0({2}DG,SC:U),B,1,-2
T:Fpass_screen$tag_struct_player_object[({0}S:S$initX$0_0$0({1}SC:U),Z,0,0)({1}S:S$posnX$0_0$0({2}SI:U),Z,0,0)({3}S:S$tileX$0_0$0({2}SI:U),Z,0,0)({5}S:S$lookX$0_0$0({1}SC:U),Z,0,0)({6}S:S$posnY$0_0$0({1}SC:U),Z,0,0)({7}S:S$tileY$0_0$0({1}SC:U),Z,0,0)({8}S:S$leapY$0_0$0({2}SI:U),Z,0,0)({10}S:S$drawX$0_0$0({1}SC:U),Z,0,0)({11}S:S$drawY$0_0$0({1}SC:U),Z,0,0)({12}S:S$player_state$0_0$0({1}SC:U),Z,0,0)({13}S:S$jumper_index$0_0$0({1}SC:U),Z,0,0)({14}S:S$deltaY_index$0_0$0({1}SC:U),Z,0,0)({15}S:S$player_frame$0_0$0({1}SC:U),Z,0,0)({16}S:S$player_lives$0_0$0({1}SC:U),Z,0,0)({17}S:S$motion_count$0_0$0({1}SC:U),Z,0,0)]
T:Fpass_screen$tag_struct_scroll_object[({0}S:S$scrollLeftX$0_0$0({1}SC:U),Z,0,0)({1}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({2}S:S$scrollColumn$0_0$0({2}SI:U),Z,0,0)({4}S:S$scrollChecks$0_0$0({2}SI:U),Z,0,0)({6}S:S$scrollPoints$0_0$0({2}SI:U),Z,0,0)({8}S:S$scrollFinish$0_0$0({2}SI:U),Z,0,0)({10}S:S$scrollLeftX0$0_0$0({1}SC:U),Z,0,0)({11}S:S$scrollLeftX1$0_0$0({1}SC:U),Z,0,0)({12}S:S$scrollLeftX2$0_0$0({1}SC:U),Z,0,0)({13}S:S$scrollLeftX3$0_0$0({1}SC:U),Z,0,0)({14}S:S$scrollLeftX4$0_0$0({1}SC:U),Z,0,0)({15}S:S$scrollLeftX5$0_0$0({1}SC:U),Z,0,0)({16}S:S$scroll_half$0_0$0({1}SC:U),Z,0,0)({17}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
T:Fpass_screen$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_saved$0_0$0({1}SC:U),Z,0,0)({6}S:S$game_start$0_0$0({1}SC:U),Z,0,0)({7}S:S$game_music$0_0$0({1}SC:U),Z,0,0)({8}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)({9}S:S$game_isgod$0_0$0({1}SC:U),Z,0,0)({10}S:S$game_sheet$0_0$0({1}SC:U),Z,0,0)]
T:Fpass_screen$tag_struct_command_object[({0}S:S$frame_index$0_0$0({2}SI:U),Z,0,0)({2}S:S$curr_command$0_0$0({1}SC:U),Z,0,0)({3}S:S$prev_command$0_0$0({1}SC:U),Z,0,0)]
...
T:Fpass_screen$tag_struct_reset_object[({0}S:S$reset_value$0_0$0({2}SI:U),Z,0,0)({2}S:S$reset_timer$0_0$0({2}SI:U),Z,0,0)]
...
S:Fpass_screen$player_passX$0_0$0({1}SC:U),E,0,0
S:Fpass_screen$player_endY$0_0$0({1}SC:U),E,0,0
S:Fpass_screen$swap$0_0$0({1}SC:U),E,0,0
S:Fpass_screen$count$0_0$0({1}SC:U),E,0,0
...
S:Lpass_screen.screen_pass_screen_load$index$1_0$156({1}SC:U),E,0,0
S:Lpass_screen.screen_pass_screen_load$maxim$1_0$156({1}SC:U),E,0,0
