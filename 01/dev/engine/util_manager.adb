...
S:Lutil_manager.engine_util_manager_locale_blank$y$1_0$119({1}SC:U),B,1,6
S:Lutil_manager.engine_util_manager_locale_blank$blank$1_0$120({2}DG,SC:U),R,0,0,[c,b]
F:G$engine_util_manager_convertByteToNibbles$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lutil_manager.engine_util_manager_convertByteToNibbles$byte$1_0$121({1}SC:U),B,1,4
S:Lutil_manager.engine_util_manager_convertByteToNibbles$upper_nibble$1_0$121({2}DG,SC:U),B,1,5
S:Lutil_manager.engine_util_manager_convertByteToNibbles$lower_nibble$1_0$121({2}DG,SC:U),B,1,7
F:G$engine_util_manager_convertNibblesToByte$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lutil_manager.engine_util_manager_convertNibblesToByte$upper_nibble$1_0$123({1}SC:U),B,1,4
S:Lutil_manager.engine_util_manager_convertNibblesToByte$lower_nibble$1_0$123({1}SC:U),B,1,5
