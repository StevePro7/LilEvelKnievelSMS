...
S:Ldebug_manager.engine_debug_manager_initgame$po$1_0$119({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldebug_manager.engine_debug_manager_initgame$go$1_0$119({2}DG,STtag_struct_game_object:S),R,0,0,[]
...
T:Fdebug_manager$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_check$0_0$0({2}SI:U),Z,0,0)({7}S:S$check_width$0_0$0({1}SC:U),Z,0,0)({8}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
