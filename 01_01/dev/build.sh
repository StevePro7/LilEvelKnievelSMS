...
##sdcc --debug -c -mz80 --opt-code-size --peep-file ../peep-rules.txt --std-c99 command_object.c
...
##sdcc --debug -c -mz80 --opt-code-size --peep-file ../peep-rules.txt --std-c99 player_object.c
##sdcc --debug -c -mz80 --opt-code-size --peep-file ../peep-rules.txt --std-c99 riff_object.c
