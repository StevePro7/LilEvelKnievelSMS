...
S:Ldiff_screen.screen_diff_screen_update$screen_type$1_0$139({2}DG,SC:U),B,1,4
S:Ldiff_screen.screen_diff_screen_update$po$1_0$140({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldiff_screen.screen_diff_screen_update$input1$1_0$140({1}SC:U),R,0,0,[a]
S:Ldiff_screen.screen_diff_screen_update$input2$1_0$140({1}SC:U),R,0,0,[a]
S:Ldiff_screen.screen_diff_screen_update$updateDiff$1_0$140({1}:S),R,0,0,[c]
F:Fdiff_screen$setupPlayer$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldiff_screen.setupPlayer$po$1_0$152({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldiff_screen.setupPlayer$go$1_0$152({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:Fdiff_screen$printCursor$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ldiff_screen.printCursor$index$1_0$153({1}SC:U),R,0,0,[c]
