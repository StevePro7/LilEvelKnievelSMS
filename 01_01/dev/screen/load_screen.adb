...
S:Lload_screen.screen_load_screen_load$po$1_0$139({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$lo$1_0$139({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$go$1_0$139({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$player_loadY$1_0$139({1}SC:U),R,0,0,[a]
S:Lload_screen.screen_load_screen_load$checkScreen$1_0$139({1}SC:U),B,1,-1
S:Lload_screen.screen_load_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_load_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lload_screen.screen_load_screen_update$screen_type$1_0$140({2}DG,SC:U),B,1,4
S:Lload_screen.screen_load_screen_update$go$1_0$141({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_update$ho$1_0$141({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_update$index$1_0$141({1}SC:U),R,0,0,[a]
S:Lload_screen.screen_load_screen_update$maxim$1_0$141({1}SC:U),R,0,0,[]
S:Lload_screen.screen_load_screen_update$input$1_0$141({1}SC:U),R,0,0,[e]
...
T:Fload_screen$tag_struct_command_object[({0}S:S$frame_index$0_0$0({2}SI:U),Z,0,0)({2}S:S$prev_command$0_0$0({1}SC:U),Z,0,0)]
