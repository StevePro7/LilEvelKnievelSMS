...
S:Lload_screen.screen_load_screen_load$po$1_0$142({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$lo$1_0$142({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$go$1_0$142({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_load$player_loadY$1_0$142({1}SC:U),R,0,0,[a]
S:Lload_screen.screen_load_screen_load$checkScreen$1_0$142({1}SC:U),B,1,-1
S:Lload_screen.screen_load_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_load_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lload_screen.screen_load_screen_update$screen_type$1_0$143({2}DG,SC:U),B,1,4
S:Lload_screen.screen_load_screen_update$go$1_0$144({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_update$ho$1_0$144({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lload_screen.screen_load_screen_update$index$1_0$144({1}SC:U),R,0,0,[a]
S:Lload_screen.screen_load_screen_update$maxim$1_0$144({1}SC:U),R,0,0,[]
S:Lload_screen.screen_load_screen_update$input$1_0$144({1}SC:U),R,0,0,[e]
...
T:Fload_screen$tag_struct_scroll_object[({0}S:S$scrollLeftX$0_0$0({1}SC:U),Z,0,0)({1}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({2}S:S$scrollColumn$0_0$0({2}SI:U),Z,0,0)({4}S:S$scrollChecks$0_0$0({2}SI:U),Z,0,0)({6}S:S$scrollPoints$0_0$0({2}SI:U),Z,0,0)({8}S:S$scrollFinish$0_0$0({2}SI:U),Z,0,0)({10}S:S$scrollLeftX0$0_0$0({1}SC:U),Z,0,0)({11}S:S$scrollLeftX1$0_0$0({1}SC:U),Z,0,0)({12}S:S$scrollLeftX2$0_0$0({1}SC:U),Z,0,0)({13}S:S$scrollLeftX3$0_0$0({1}SC:U),Z,0,0)({14}S:S$scrollLeftX4$0_0$0({1}SC:U),Z,0,0)({15}S:S$scrollLeftX5$0_0$0({1}SC:U),Z,0,0)({16}S:S$scroll_half$0_0$0({1}SC:U),Z,0,0)({17}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
T:Fload_screen$tag_struct_hack_object[({0}S:S$hack_delay$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_isgod$0_0$0({1}SC:U),Z,0,0)({2}S:S$hack_inair$0_0$0({1}SC:U),Z,0,0)({3}S:S$hack_ultra$0_0$0({1}SC:U),Z,0,0)({4}S:S$hack_music$0_0$0({1}SC:U),Z,0,0)({5}S:S$hack_sound$0_0$0({1}SC:U),Z,0,0)({6}S:S$hack_riffs$0_0$0({1}SC:U),Z,0,0)]
T:Fload_screen$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_saved$0_0$0({1}SC:U),Z,0,0)({6}S:S$game_start$0_0$0({1}SC:U),Z,0,0)({7}S:S$game_music$0_0$0({1}SC:U),Z,0,0)({8}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)({9}S:S$game_isgod$0_0$0({1}SC:U),Z,0,0)({10}S:S$game_sheet$0_0$0({1}SC:U),Z,0,0)]
T:Fload_screen$tag_struct_command_object[({0}S:S$frame_index$0_0$0({2}SI:U),Z,0,0)({2}S:S$curr_command$0_0$0({1}SC:U),Z,0,0)({3}S:S$prev_command$0_0$0({1}SC:U),Z,0,0)]
T:Fload_screen$tag_struct_frame_object[({0}S:S$frame_count$0_0$0({2}SI:U),Z,0,0)]
T:Fload_screen$tag_struct_delay_object[({0}S:S$delay_value$0_0$0({2}SI:U),Z,0,0)({2}S:S$delay_timer$0_0$0({2}SI:U),Z,0,0)]
T:Fload_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_check$0_0$0({2}SI:U),Z,0,0)({7}S:S$check_width$0_0$0({1}SC:U),Z,0,0)({8}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
T:Fload_screen$tag_struct_reset_object[({0}S:S$reset_value$0_0$0({2}SI:U),Z,0,0)({2}S:S$reset_timer$0_0$0({2}SI:U),Z,0,0)]
...
S:Fload_screen$check$0_0$0({1}SC:U),E,0,0
S:Fload_screen$delay$0_0$0({1}SC:U),E,0,0
