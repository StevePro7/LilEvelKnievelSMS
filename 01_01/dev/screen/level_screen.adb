...
S:Llevel_screen.screen_level_screen_load$po$1_0$150({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Llevel_screen.screen_level_screen_load$lo$1_0$150({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_screen.screen_level_screen_load$go$1_0$150({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_level_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_screen.screen_level_screen_update$screen_type$1_0$152({2}DG,SC:U),B,1,4
S:Llevel_screen.screen_level_screen_update$po$1_0$153({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Llevel_screen.screen_level_screen_update$lo$1_0$153({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_screen.screen_level_screen_update$input$1_0$153({1}SC:U),R,0,0,[a]
S:Llevel_screen.screen_level_screen_update$updateLevel$1_0$153({1}:S),B,1,-1
S:Llevel_screen.screen_level_screen_update$sloc0$0_1$0({1}:S),B,1,-1
F:Flevel_screen$updateCheck$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_screen.updateCheck$lo$1_0$180({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_screen.updateCheck$go$1_0$180({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:Flevel_screen$printStats$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_screen.printStats$delta$1_0$181({1}SC:U),R,0,0,[]
...
T:Flevel_screen$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_saved$0_0$0({1}SC:U),Z,0,0)({6}S:S$game_start$0_0$0({1}SC:U),Z,0,0)({7}S:S$game_music$0_0$0({1}SC:U),Z,0,0)({8}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)({9}S:S$game_isgod$0_0$0({1}SC:U),Z,0,0)({10}S:S$game_sheet$0_0$0({1}SC:U),Z,0,0)]
T:Flevel_screen$tag_struct_storage_object[({0}S:S$Magic$0_0$0({4}SL:U),Z,0,0)({4}S:S$storage_difficulty$0_0$0({1}SC:U),Z,0,0)({5}S:S$storage_world$0_0$0({1}SC:U),Z,0,0)({6}S:S$storage_round$0_0$0({1}SC:U),Z,0,0)({7}S:S$storage_level$0_0$0({1}SC:U),Z,0,0)({8}S:S$storage_point$0_0$0({1}SC:U),Z,0,0)({9}S:S$storage_saved$0_0$0({1}SC:U),Z,0,0)({10}S:S$storage_padding$0_0$0({6}DA6d,SC:U),Z,0,0)({16}S:S$storage_frame_index$0_0$0({128}DA64d,SI:U),Z,0,0)({144}S:S$storage_this_command$0_0$0({64}DA64d,SC:U),Z,0,0)({208}S:S$terminal$0_0$0({1}SC:U),Z,0,0)]
T:Flevel_screen$tag_struct_audio_object[({0}S:S$music_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$music_bank$0_0$0({1}SC:U),Z,0,0)({3}S:S$sound_data$0_0$0({2}DG,SC:U),Z,0,0)({5}S:S$sound_bank$0_0$0({1}SC:U),Z,0,0)]
T:Flevel_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_check$0_0$0({2}SI:U),Z,0,0)({7}S:S$check_width$0_0$0({1}SC:U),Z,0,0)({8}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
S:Flevel_screen$cursorX$0_0$0({3}DA3d,SC:U),E,0,0
...
S:Flevel_screen$game_world$0_0$0({1}SC:U),E,0,0
...
S:Flevel_screen$check$0_0$0({1}SC:U),E,0,0
