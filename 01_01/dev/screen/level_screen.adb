...
S:Llevel_screen.screen_level_screen_load$po$1_0$147({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Llevel_screen.screen_level_screen_load$lo$1_0$147({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_screen.screen_level_screen_load$go$1_0$147({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_level_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_screen.screen_level_screen_update$screen_type$1_0$149({2}DG,SC:U),B,1,4
...
S:Llevel_screen.updateCheck$lo$1_0$177({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_screen.updateCheck$go$1_0$177({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:Flevel_screen$printStats$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_screen.printStats$delta$1_0$178({1}SC:U),R,0,0,[]
