...
S:Ltitle_screen.screen_title_screen_load$go$1_0$132({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Ltitle_screen.screen_title_screen_load$flips$1_0$132({1}SC:U),R,0,0,[e]
F:G$screen_title_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltitle_screen.screen_title_screen_update$screen_type$1_0$135({2}DG,SC:U),B,1,4
S:Ltitle_screen.screen_title_screen_update$input$1_0$136({1}SC:U),R,0,0,[a]
S:Ltitle_screen.screen_title_screen_update$x$1_0$136({1}SC:U),R,0,0,[c]
S:Ltitle_screen.screen_title_screen_update$y$1_0$136({1}SC:U),R,0,0,[b]
S:Ltitle_screen.screen_title_screen_update$f$1_0$136({1}SC:U),R,0,0,[a]
F:Ftitle_screen$draw_sprite$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Ltitle_screen.draw_sprite$idx$1_0$140({1}SC:U),B,1,4
S:Ltitle_screen.draw_sprite$mode$1_0$140({1}SC:U),B,1,5
S:Ltitle_screen.draw_sprite$x$1_0$140({1}SC:U),B,1,6
S:Ltitle_screen.draw_sprite$y$1_0$140({1}SC:U),B,1,7
