...
S:Loption_screen.screen_option_screen_load$idx$1_0$120({1}SC:U),R,0,0,[b]
F:G$screen_option_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Loption_screen.screen_option_screen_update$screen_type$1_0$123({2}DG,SC:U),B,1,4
S:Loption_screen.screen_option_screen_update$input1$1_0$124({1}SC:U),R,0,0,[c]
S:Loption_screen.screen_option_screen_update$input2$1_0$124({1}SC:U),R,0,0,[l]
S:Loption_screen.screen_option_screen_update$input3$1_0$124({1}SC:U),R,0,0,[l]
...
T:Foption_screen$tag_struct_scroll_object[({0}S:S$scrollLeftX$0_0$0({1}SC:U),Z,0,0)({1}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({2}S:S$scrollColumn$0_0$0({2}SI:U),Z,0,0)({4}S:S$scrollChecks$0_0$0({2}SI:U),Z,0,0)({6}S:S$scrollPoints$0_0$0({2}SI:U),Z,0,0)({8}S:S$scrollFinish$0_0$0({2}SI:U),Z,0,0)({10}S:S$scrollLeftX0$0_0$0({1}SC:U),Z,0,0)({11}S:S$scrollLeftX1$0_0$0({1}SC:U),Z,0,0)({12}S:S$scrollLeftX2$0_0$0({1}SC:U),Z,0,0)({13}S:S$scrollLeftX3$0_0$0({1}SC:U),Z,0,0)({14}S:S$scrollLeftX4$0_0$0({1}SC:U),Z,0,0)({15}S:S$scrollLeftX5$0_0$0({1}SC:U),Z,0,0)({16}S:S$scroll_half$0_0$0({1}SC:U),Z,0,0)({17}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
