M:repeat_screen
F:G$screen_repeat_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lrepeat_screen.screen_repeat_screen_load$po$1_0$141({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lrepeat_screen.screen_repeat_screen_load$lo$1_0$141({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lrepeat_screen.screen_repeat_screen_load$go$1_0$141({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lrepeat_screen.screen_repeat_screen_load$player_loadY$1_0$141({1}SC:U),R,0,0,[a]
S:Lrepeat_screen.screen_repeat_screen_load$checkScreen$1_0$141({1}SC:U),B,1,-1
S:Lrepeat_screen.screen_repeat_screen_load$cloud_formation$1_0$141({1}SC:U),R,0,0,[]
...
S:Lrepeat_screen.screen_repeat_screen_update$screen_type$1_0$143({2}DG,SC:U),B,1,4
S:Lrepeat_screen.screen_repeat_screen_update$fo$1_0$144({2}DG,STtag_struct_frame_object:S),R,0,0,[]
S:Lrepeat_screen.screen_repeat_screen_update$so$1_0$144({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lrepeat_screen.screen_repeat_screen_update$po$1_0$144({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lrepeat_screen.screen_repeat_screen_update$lo$1_0$144({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lrepeat_screen.screen_repeat_screen_update$go$1_0$144({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lrepeat_screen.screen_repeat_screen_update$co$1_0$144({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Lrepeat_screen.screen_repeat_screen_update$input1$1_0$144({1}SC:U),B,1,-2
S:Lrepeat_screen.screen_repeat_screen_update$input2$1_0$144({1}SC:U),B,1,-1
S:Lrepeat_screen.screen_repeat_screen_update$deltaX$1_0$144({1}SC:U),B,1,-1
S:Lrepeat_screen.screen_repeat_screen_update$deltaY$1_0$144({2}SI:S),R,0,0,[c,b]
S:Lrepeat_screen.screen_repeat_screen_update$loops$1_0$144({1}SC:U),R,0,0,[c]
S:Lrepeat_screen.screen_repeat_screen_update$scroll_state$1_0$144({1}SC:U),R,0,0,[a]
S:Lrepeat_screen.screen_repeat_screen_update$player_state$1_0$144({1}SC:U),B,1,-3
S:Lrepeat_screen.screen_repeat_screen_update$command$1_0$144({1}SC:U),B,1,-4
S:Lrepeat_screen.screen_repeat_screen_update$sloc0$0_1$0({1}SC:U),B,1,-4
S:Lrepeat_screen.screen_repeat_screen_update$sloc1$0_1$0({1}SC:U),B,1,-3
S:Lrepeat_screen.screen_repeat_screen_update$sloc2$0_1$0({1}SC:U),B,1,-2
S:Lrepeat_screen.screen_repeat_screen_update$sloc3$0_1$0({1}SC:U),B,1,-1
S:Lrepeat_screen.screen_repeat_screen_update$sloc4$0_1$0({1}SC:U),B,1,-1
S:Lrepeat_screen.screen_repeat_screen_update$sloc5$0_1$0({2}SI:S),B,1,-2
S:Lrepeat_screen.screen_repeat_screen_update$sloc6$0_1$0({2}SI:U),B,1,-5
S:Lrepeat_screen.screen_repeat_screen_update$sloc7$0_1$0({2}DD,SI:U),B,1,-2
S:Lrepeat_screen.screen_repeat_screen_update$sloc8$0_1$0({2}SI:U),B,1,-5
...
T:Frepeat_screen$tag_struct_command_object[({0}S:S$frame_index$0_0$0({2}SI:U),Z,0,0)({2}S:S$curr_command$0_0$0({1}SC:U),Z,0,0)({3}S:S$prev_command$0_0$0({1}SC:U),Z,0,0)]
...
T:Frepeat_screen$tag_struct_frame_object[({0}S:S$frame_count$0_0$0({2}SI:U),Z,0,0)]
T:Frepeat_screen$tag_struct_delay_object[({0}S:S$delay_value$0_0$0({2}SI:U),Z,0,0)({2}S:S$delay_timer$0_0$0({2}SI:U),Z,0,0)]
T:Frepeat_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_check$0_0$0({2}SI:U),Z,0,0)({7}S:S$check_width$0_0$0({1}SC:U),Z,0,0)({8}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
T:Frepeat_screen$tag_struct_reset_object[({0}S:S$reset_value$0_0$0({2}SI:U),Z,0,0)({2}S:S$reset_timer$0_0$0({2}SI:U),Z,0,0)]
