...
S:Lcont_screen.printContinue$tiles$1_0$146({2}DG,SC:U),R,0,0,[c,b]
S:Lcont_screen.printContinue$x$1_0$146({1}SC:U),R,0,0,[]
S:Lcont_screen.printContinue$y$1_0$146({1}SC:U),R,0,0,[]
S:Lcont_screen.printContinue$d$1_0$146({1}SC:U),R,0,0,[]
F:G$screen_cont_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lcont_screen.screen_cont_screen_load$po$1_0$147({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lcont_screen.screen_cont_screen_load$lo$1_0$147({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lcont_screen.screen_cont_screen_load$go$1_0$147({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lcont_screen.screen_cont_screen_load$player_loadY$1_0$147({1}SC:U),R,0,0,[a]
S:Lcont_screen.screen_cont_screen_load$checkScreen$1_0$147({1}SC:U),B,1,-1
S:Lcont_screen.screen_cont_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_cont_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lcont_screen.screen_cont_screen_update$screen_type$1_0$148({2}DG,SC:U),B,1,4
S:Lcont_screen.screen_cont_screen_update$po$1_0$149({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lcont_screen.screen_cont_screen_update$go$1_0$149({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lcont_screen.screen_cont_screen_update$input1$1_0$149({1}SC:U),R,0,0,[l]
S:Lcont_screen.screen_cont_screen_update$input2$1_0$149({1}SC:U),R,0,0,[a]
