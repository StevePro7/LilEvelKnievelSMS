...
S:Lpass_screen.screen_pass_screen_load$game_level$1_0$153({1}SC:U),R,0,0,[]
F:G$screen_pass_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lpass_screen.screen_pass_screen_update$screen_type$1_0$156({2}DG,SC:U),B,1,4
S:Lpass_screen.screen_pass_screen_update$po$1_0$157({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lpass_screen.screen_pass_screen_update$go$1_0$157({2}DG,STtag_struct_game_object:S),R,0,0,[]
...
T:Fpass_screen$tag_struct_command_object[({0}S:S$frame_index$0_0$0({2}SI:U),Z,0,0)({2}S:S$prev_command$0_0$0({1}SC:U),Z,0,0)]
