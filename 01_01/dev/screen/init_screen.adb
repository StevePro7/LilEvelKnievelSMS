...
S:Linit_screen.screen_init_screen_load$go$1_0$37({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Linit_screen.screen_init_screen_load$game_music$1_0$37({1}SC:U),R,0,0,[a]
F:G$screen_init_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Linit_screen.screen_init_screen_update$screen_type$1_0$38({2}DG,SC:U),B,1,4
