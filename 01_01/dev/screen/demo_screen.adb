...
S:Ldemo_screen.screen_demo_screen_load$po$1_0$144({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$lo$1_0$144({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$go$1_0$144({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$player_loadY$1_0$144({1}SC:U),R,0,0,[a]
S:Ldemo_screen.screen_demo_screen_load$checkScreen$1_0$144({1}SC:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$demo_level$1_0$144({1}SC:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$game_difficulty$1_0$144({1}SC:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$game_world$1_0$144({1}SC:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$game_point$1_0$144({1}SC:U),R,0,0,[]
F:G$screen_demo_screen_update$0_0$0({2}DF,SV:S),Z,0,-27,0,0,0
S:Ldemo_screen.screen_demo_screen_update$screen_type$1_0$145({2}DG,SC:U),B,1,4
S:Ldemo_screen.screen_demo_screen_update$fo$1_0$146({2}DG,STtag_struct_frame_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$ho$1_0$146({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$so$1_0$146({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$po$1_0$146({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$lo$1_0$146({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$go$1_0$146({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$co$1_0$146({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$input1$1_0$146({1}SC:U),B,1,-3
S:Ldemo_screen.screen_demo_screen_update$input2$1_0$146({1}SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$deltaX$1_0$146({1}SC:U),B,1,-3
S:Ldemo_screen.screen_demo_screen_update$deltaY$1_0$146({2}SI:S),B,1,-7
S:Ldemo_screen.screen_demo_screen_update$loops$1_0$146({1}SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$scroll_state$1_0$146({1}SC:U),R,0,0,[a]
S:Ldemo_screen.screen_demo_screen_update$player_state$1_0$146({1}SC:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$command$1_0$146({1}SC:U),B,1,-1
S:Ldemo_screen.screen_demo_screen_update$sloc0$0_1$0({1}SC:U),B,1,-1
S:Ldemo_screen.screen_demo_screen_update$sloc1$0_1$0({1}SC:U),B,1,-3
S:Ldemo_screen.screen_demo_screen_update$sloc2$0_1$0({1}SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc3$0_1$0({1}SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc4$0_1$0({2}DG,SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc5$0_1$0({2}SI:S),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc6$0_1$0({2}SI:U),B,1,-4
S:Ldemo_screen.screen_demo_screen_update$sloc7$0_1$0({2}DD,SI:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc8$0_1$0({2}SI:U),B,1,-4
S:Ldemo_screen.screen_demo_screen_update$sloc9$0_1$0({2}SI:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc10$0_1$0({2}DD,SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc11$0_1$0({1}SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc12$0_1$0({1}SC:U),B,1,-3
S:Ldemo_screen.screen_demo_screen_update$sloc13$0_1$0({1}SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc14$0_1$0({2}SI:S),B,1,-7
S:Ldemo_screen.screen_demo_screen_update$sloc15$0_1$0({2}SI:S),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc16$0_1$0({1}SC:U),B,1,-5
S:Ldemo_screen.screen_demo_screen_update$sloc17$0_1$0({1}SC:U),B,1,-4
S:Ldemo_screen.screen_demo_screen_update$sloc18$0_1$0({1}SC:U),B,1,-3
S:Ldemo_screen.screen_demo_screen_update$sloc19$0_1$0({1}SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc20$0_1$0({1}SC:U),B,1,-1
S:Ldemo_screen.screen_demo_screen_update$sloc21$0_1$0({2}DG,SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$sloc22$0_1$0({2}DG,SC:U),B,1,-2
T:Fdemo_screen$tag_struct_player_object[({0}S:S$initX$0_0$0({1}SC:U),Z,0,0)({1}S:S$posnX$0_0$0({2}SI:U),Z,0,0)({3}S:S$tileX$0_0$0({2}SI:U),Z,0,0)({5}S:S$lookX$0_0$0({1}SC:U),Z,0,0)({6}S:S$posnY$0_0$0({1}SC:U),Z,0,0)({7}S:S$tileY$0_0$0({1}SC:U),Z,0,0)({8}S:S$leapY$0_0$0({2}SI:U),Z,0,0)({10}S:S$drawX$0_0$0({1}SC:U),Z,0,0)({11}S:S$drawY$0_0$0({1}SC:U),Z,0,0)({12}S:S$player_state$0_0$0({1}SC:U),Z,0,0)({13}S:S$jumper_index$0_0$0({1}SC:U),Z,0,0)({14}S:S$deltaY_index$0_0$0({1}SC:U),Z,0,0)({15}S:S$player_frame$0_0$0({1}SC:U),Z,0,0)({16}S:S$player_lives$0_0$0({1}SC:U),Z,0,0)({17}S:S$motion_count$0_0$0({1}SC:U),Z,0,0)]
T:Fdemo_screen$tag_struct_scroll_object[({0}S:S$scrollLeftX$0_0$0({1}SC:U),Z,0,0)({1}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({2}S:S$scrollColumn$0_0$0({2}SI:U),Z,0,0)({4}S:S$scrollChecks$0_0$0({2}SI:U),Z,0,0)({6}S:S$scrollPoints$0_0$0({2}SI:U),Z,0,0)({8}S:S$scrollFinish$0_0$0({2}SI:U),Z,0,0)({10}S:S$scrollLeftX0$0_0$0({1}SC:U),Z,0,0)({11}S:S$scrollLeftX1$0_0$0({1}SC:U),Z,0,0)({12}S:S$scrollLeftX2$0_0$0({1}SC:U),Z,0,0)({13}S:S$scrollLeftX3$0_0$0({1}SC:U),Z,0,0)({14}S:S$scrollLeftX4$0_0$0({1}SC:U),Z,0,0)({15}S:S$scrollLeftX5$0_0$0({1}SC:U),Z,0,0)({16}S:S$scroll_half$0_0$0({1}SC:U),Z,0,0)({17}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
T:Fdemo_screen$tag_struct_hack_object[({0}S:S$hack_delay$0_0$0({1}SC:U),Z,0,0)({1}S:S$hack_isgod$0_0$0({1}SC:U),Z,0,0)({2}S:S$hack_inair$0_0$0({1}SC:U),Z,0,0)({3}S:S$hack_ultra$0_0$0({1}SC:U),Z,0,0)({4}S:S$hack_music$0_0$0({1}SC:U),Z,0,0)({5}S:S$hack_sound$0_0$0({1}SC:U),Z,0,0)({6}S:S$hack_riffs$0_0$0({1}SC:U),Z,0,0)]
T:Fdemo_screen$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_saved$0_0$0({1}SC:U),Z,0,0)({6}S:S$game_start$0_0$0({1}SC:U),Z,0,0)({7}S:S$game_music$0_0$0({1}SC:U),Z,0,0)({8}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)({9}S:S$game_isgod$0_0$0({1}SC:U),Z,0,0)({10}S:S$game_sheet$0_0$0({1}SC:U),Z,0,0)]
T:Fdemo_screen$tag_struct_command_object[({0}S:S$frame_index$0_0$0({2}SI:U),Z,0,0)({2}S:S$curr_command$0_0$0({1}SC:U),Z,0,0)({3}S:S$prev_command$0_0$0({1}SC:U),Z,0,0)]
T:Fdemo_screen$tag_struct_storage_object[({0}S:S$Magic$0_0$0({4}SL:U),Z,0,0)({4}S:S$storage_difficulty$0_0$0({1}SC:U),Z,0,0)({5}S:S$storage_world$0_0$0({1}SC:U),Z,0,0)({6}S:S$storage_round$0_0$0({1}SC:U),Z,0,0)({7}S:S$storage_level$0_0$0({1}SC:U),Z,0,0)({8}S:S$storage_point$0_0$0({1}SC:U),Z,0,0)({9}S:S$storage_saved$0_0$0({1}SC:U),Z,0,0)({10}S:S$storage_padding$0_0$0({6}DA6d,SC:U),Z,0,0)({16}S:S$storage_frame_index$0_0$0({128}DA64d,SI:U),Z,0,0)({144}S:S$storage_this_command$0_0$0({64}DA64d,SC:U),Z,0,0)({208}S:S$terminal$0_0$0({1}SC:U),Z,0,0)]
...
S:Fdemo_screen$complete$0_0$0({1}:S),E,0,0
S:Fdemo_screen$frame_counter$0_0$0({1}SC:U),E,0,0
S:Fdemo_screen$available$0_0$0({1}SC:U),E,0,0
S:Fdemo_screen$local_prev_command$0_0$0({1}SC:U),E,0,0
S:Fdemo_screen$delay$0_0$0({1}SC:U),E,0,0
S:Fdemo_screen$check$0_0$0({1}SC:U),E,0,0
S:Fdemo_screen$flag$0_0$0({1}:S),E,0,0
