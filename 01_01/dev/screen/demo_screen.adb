...
S:Ldemo_screen.screen_demo_screen_load$po$1_0$137({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$lo$1_0$137({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$go$1_0$137({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$player_loadY$1_0$137({1}SC:U),R,0,0,[a]
S:Ldemo_screen.screen_demo_screen_load$checkScreen$1_0$137({1}SC:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$demo_level$1_0$137({1}SC:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$game_difficulty$1_0$137({1}SC:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$game_world$1_0$137({1}SC:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_load$game_point$1_0$137({1}SC:U),R,0,0,[]
F:G$screen_demo_screen_update$0_0$0({2}DF,SV:S),Z,0,-27,0,0,0
S:Ldemo_screen.screen_demo_screen_update$screen_type$1_0$138({2}DG,SC:U),B,1,4
S:Ldemo_screen.screen_demo_screen_update$fo$1_0$139({2}DG,STtag_struct_frame_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$ho$1_0$139({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$so$1_0$139({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$po$1_0$139({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$lo$1_0$139({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$go$1_0$139({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$co$1_0$139({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$input1$1_0$139({1}SC:U),B,1,-3
S:Ldemo_screen.screen_demo_screen_update$input2$1_0$139({1}SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$deltaX$1_0$139({1}SC:U),B,1,-3
S:Ldemo_screen.screen_demo_screen_update$deltaY$1_0$139({2}SI:S),B,1,-7
S:Ldemo_screen.screen_demo_screen_update$loops$1_0$139({1}SC:U),B,1,-2
S:Ldemo_screen.screen_demo_screen_update$scroll_state$1_0$139({1}SC:U),R,0,0,[a]
S:Ldemo_screen.screen_demo_screen_update$player_state$1_0$139({1}SC:U),R,0,0,[]
S:Ldemo_screen.screen_demo_screen_update$command$1_0$139({1}SC:U),B,1,-1
