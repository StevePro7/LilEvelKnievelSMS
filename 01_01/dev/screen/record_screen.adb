M:record_screen
F:G$screen_record_screen_load$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lrecord_screen.screen_record_screen_load$po$1_0$142({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_load$lo$1_0$142({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_load$go$1_0$142({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_load$player_loadY$1_0$142({1}SC:U),R,0,0,[a]
S:Lrecord_screen.screen_record_screen_load$checkScreen$1_0$142({1}SC:U),B,1,-1
S:Lrecord_screen.screen_record_screen_load$cloud_formation$1_0$142({1}SC:U),R,0,0,[]
S:Lrecord_screen.screen_record_screen_load$sloc0$0_1$0({1}SC:U),B,1,-1
F:G$screen_record_screen_update$0_0$0({2}DF,SV:S),Z,0,-4,0,0,0
S:Lrecord_screen.screen_record_screen_update$screen_type$1_0$143({2}DG,SC:U),B,1,4
S:Lrecord_screen.screen_record_screen_update$fo$1_0$144({2}DG,STtag_struct_frame_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_update$so$1_0$144({2}DG,STtag_struct_scroll_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_update$po$1_0$144({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_update$co$1_0$144({2}DG,STtag_struct_command_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_update$lo$1_0$144({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_update$go$1_0$144({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lrecord_screen.screen_record_screen_update$input1$1_0$144({1}SC:U),B,1,-4
S:Lrecord_screen.screen_record_screen_update$input2$1_0$144({1}SC:U),B,1,-3
S:Lrecord_screen.screen_record_screen_update$input3$1_0$144({1}SC:U),B,1,-2
S:Lrecord_screen.screen_record_screen_update$input4$1_0$144({1}SC:U),B,1,-1
S:Lrecord_screen.screen_record_screen_update$input5$1_0$144({1}SC:U),R,0,0,[c]
S:Lrecord_screen.screen_record_screen_update$input6$1_0$144({1}SC:U),R,0,0,[a]
S:Lrecord_screen.screen_record_screen_update$command$1_0$144({1}SC:U),B,1,-1
S:Lrecord_screen.screen_record_screen_update$deltaX$1_0$144({1}SC:U),R,0,0,[b]
S:Lrecord_screen.screen_record_screen_update$deltaY$1_0$144({2}SI:S),B,1,-6
S:Lrecord_screen.screen_record_screen_update$loops$1_0$144({1}SC:U),R,0,0,[c]
S:Lrecord_screen.screen_record_screen_update$scroll_state$1_0$144({1}SC:U),R,0,0,[a]
S:Lrecord_screen.screen_record_screen_update$player_state$1_0$144({1}SC:U),B,1,-7
S:Lrecord_screen.screen_record_screen_update$sloc0$0_1$0({1}SC:U),B,1,-7
S:Lrecord_screen.screen_record_screen_update$sloc1$0_1$0({2}SI:S),B,1,-6
S:Lrecord_screen.screen_record_screen_update$sloc2$0_1$0({1}SC:U),B,1,-4
S:Lrecord_screen.screen_record_screen_update$sloc3$0_1$0({1}SC:U),B,1,-3
S:Lrecord_screen.screen_record_screen_update$sloc4$0_1$0({1}SC:U),B,1,-2
S:Lrecord_screen.screen_record_screen_update$sloc5$0_1$0({1}SC:U),B,1,-1
S:Lrecord_screen.screen_record_screen_update$sloc6$0_1$0({1}SC:U),B,1,-1
S:Lrecord_screen.screen_record_screen_update$sloc7$0_1$0({1}SC:U),B,1,-2
S:Lrecord_screen.screen_record_screen_update$sloc8$0_1$0({1}SC:U),B,1,-2
S:Lrecord_screen.screen_record_screen_update$sloc9$0_1$0({1}SC:U),B,1,-1
T:Frecord_screen$tag_struct_player_object[({0}S:S$initX$0_0$0({1}SC:U),Z,0,0)({1}S:S$posnX$0_0$0({2}SI:U),Z,0,0)({3}S:S$tileX$0_0$0({2}SI:U),Z,0,0)({5}S:S$lookX$0_0$0({1}SC:U),Z,0,0)({6}S:S$posnY$0_0$0({1}SC:U),Z,0,0)({7}S:S$tileY$0_0$0({1}SC:U),Z,0,0)({8}S:S$leapY$0_0$0({2}SI:U),Z,0,0)({10}S:S$drawX$0_0$0({1}SC:U),Z,0,0)({11}S:S$drawY$0_0$0({1}SC:U),Z,0,0)({12}S:S$player_state$0_0$0({1}SC:U),Z,0,0)({13}S:S$jumper_index$0_0$0({1}SC:U),Z,0,0)({14}S:S$deltaY_index$0_0$0({1}SC:U),Z,0,0)({15}S:S$player_frame$0_0$0({1}SC:U),Z,0,0)({16}S:S$player_lives$0_0$0({1}SC:U),Z,0,0)({17}S:S$motion_count$0_0$0({1}SC:U),Z,0,0)]
T:Frecord_screen$tag_struct_scroll_object[({0}S:S$scrollLeftX$0_0$0({1}SC:U),Z,0,0)({1}S:S$scrollRight$0_0$0({1}SC:U),Z,0,0)({2}S:S$scrollColumn$0_0$0({2}SI:U),Z,0,0)({4}S:S$scrollChecks$0_0$0({2}SI:U),Z,0,0)({6}S:S$scrollPoints$0_0$0({2}SI:U),Z,0,0)({8}S:S$scrollFinish$0_0$0({2}SI:U),Z,0,0)({10}S:S$scrollLeftX0$0_0$0({1}SC:U),Z,0,0)({11}S:S$scrollLeftX1$0_0$0({1}SC:U),Z,0,0)({12}S:S$scrollLeftX2$0_0$0({1}SC:U),Z,0,0)({13}S:S$scrollLeftX3$0_0$0({1}SC:U),Z,0,0)({14}S:S$scrollLeftX4$0_0$0({1}SC:U),Z,0,0)({15}S:S$scrollLeftX5$0_0$0({1}SC:U),Z,0,0)({16}S:S$scroll_half$0_0$0({1}SC:U),Z,0,0)({17}S:S$lineCnt$0_0$0({1}SC:U),Z,0,0)]
T:Frecord_screen$tag_struct_game_object[({0}S:S$game_difficulty$0_0$0({1}SC:U),Z,0,0)({1}S:S$game_world$0_0$0({1}SC:U),Z,0,0)({2}S:S$game_round$0_0$0({1}SC:U),Z,0,0)({3}S:S$game_level$0_0$0({1}SC:U),Z,0,0)({4}S:S$game_point$0_0$0({1}SC:U),Z,0,0)({5}S:S$game_saved$0_0$0({1}SC:U),Z,0,0)({6}S:S$game_start$0_0$0({1}SC:U),Z,0,0)({7}S:S$game_music$0_0$0({1}SC:U),Z,0,0)({8}S:S$game_cloud$0_0$0({1}SC:U),Z,0,0)({9}S:S$game_isgod$0_0$0({1}SC:U),Z,0,0)({10}S:S$game_sheet$0_0$0({1}SC:U),Z,0,0)]
T:Frecord_screen$tag_struct_command_object[({0}S:S$frame_index$0_0$0({2}SI:U),Z,0,0)({2}S:S$curr_command$0_0$0({1}SC:U),Z,0,0)({3}S:S$prev_command$0_0$0({1}SC:U),Z,0,0)]
T:Frecord_screen$tag_struct_storage_object[({0}S:S$Magic$0_0$0({4}SL:U),Z,0,0)({4}S:S$storage_difficulty$0_0$0({1}SC:U),Z,0,0)({5}S:S$storage_world$0_0$0({1}SC:U),Z,0,0)({6}S:S$storage_round$0_0$0({1}SC:U),Z,0,0)({7}S:S$storage_level$0_0$0({1}SC:U),Z,0,0)({8}S:S$storage_point$0_0$0({1}SC:U),Z,0,0)({9}S:S$storage_saved$0_0$0({1}SC:U),Z,0,0)({10}S:S$storage_padding$0_0$0({6}DA6d,SC:U),Z,0,0)({16}S:S$storage_frame_index$0_0$0({128}DA64d,SI:U),Z,0,0)({144}S:S$storage_this_command$0_0$0({64}DA64d,SC:U),Z,0,0)({208}S:S$terminal$0_0$0({1}SC:U),Z,0,0)]
T:Frecord_screen$tag_struct_frame_object[({0}S:S$frame_count$0_0$0({2}SI:U),Z,0,0)]
T:Frecord_screen$tag_struct_delay_object[({0}S:S$delay_value$0_0$0({2}SI:U),Z,0,0)({2}S:S$delay_timer$0_0$0({2}SI:U),Z,0,0)]
T:Frecord_screen$tag_struct_level_object[({0}S:S$level_data$0_0$0({2}DG,SC:U),Z,0,0)({2}S:S$level_size$0_0$0({2}SI:U),Z,0,0)({4}S:S$level_bank$0_0$0({1}SC:U),Z,0,0)({5}S:S$level_check$0_0$0({2}SI:U),Z,0,0)({7}S:S$check_width$0_0$0({1}SC:U),Z,0,0)({8}S:S$column_draw$0_0$0({1}SC:U),Z,0,0)]
T:Frecord_screen$tag_struct_reset_object[({0}S:S$reset_value$0_0$0({2}SI:U),Z,0,0)({2}S:S$reset_timer$0_0$0({2}SI:U),Z,0,0)]
