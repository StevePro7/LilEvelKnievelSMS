...
S:Lready_screen.screen_ready_screen_load$po$1_0$147({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lready_screen.screen_ready_screen_load$lo$1_0$147({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lready_screen.screen_ready_screen_load$go$1_0$147({2}DG,STtag_struct_game_object:S),R,0,0,[]
F:G$screen_ready_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lready_screen.screen_ready_screen_update$screen_type$1_0$148({2}DG,SC:U),B,1,4
S:Lready_screen.screen_ready_screen_update$po$1_0$149({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lready_screen.screen_ready_screen_update$lo$1_0$149({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lready_screen.screen_ready_screen_update$input$1_0$149({1}SC:U),R,0,0,[a]
S:Lready_screen.screen_ready_screen_update$updateLevel$1_0$149({1}:S),B,1,-1
S:Lready_screen.screen_ready_screen_update$sloc0$0_1$0({1}:S),B,1,-1
F:Fready_screen$updateCheck$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lready_screen.updateCheck$lo$1_0$175({2}DG,STtag_struct_level_object:S),R,0,0,[]
F:Fready_screen$printStats$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lready_screen.printStats$delta$1_0$176({1}SC:U),R,0,0,[]
