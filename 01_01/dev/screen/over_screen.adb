...
S:Lover_screen.screen_over_screen_load$po$1_0$145({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lover_screen.screen_over_screen_load$lo$1_0$145({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Lover_screen.screen_over_screen_load$go$1_0$145({2}DG,STtag_struct_game_object:S),R,0,0,[]
S:Lover_screen.screen_over_screen_load$player_loadY$1_0$145({1}SC:U),R,0,0,[a]
S:Lover_screen.screen_over_screen_load$checkScreen$1_0$145({1}SC:U),B,1,-1
