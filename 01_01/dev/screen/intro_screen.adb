...
S:Lintro_screen.screen_intro_screen_load$col$1_0$111({1}SC:U),R,0,0,[]
S:Lintro_screen.screen_intro_screen_load$row$1_0$111({1}SC:U),R,0,0,[]
F:G$screen_intro_screen_update$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lintro_screen.screen_intro_screen_update$screen_type$1_0$112({2}DG,SC:U),B,1,4
S:Lintro_screen.screen_intro_screen_update$input1$1_0$113({1}SC:U),B,1,-1
S:Lintro_screen.screen_intro_screen_update$delay$1_0$113({1}SC:U),R,0,0,[c]
