...
S:Lplayer_manager.engine_player_manager_get_deltaY$po$1_0$156({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_get_deltaY$deltaY$1_0$156({2}SI:S),R,0,0,[e,d]
...
S:Lplayer_manager.engine_player_manager_set_action$frame$1_0$159({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_set_action$command$1_0$159({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_set_action$po$1_0$160({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
S:Lplayer_manager.engine_player_manager_set_action$newFrame$1_0$160({1}SC:U),B,1,-1
S:Lplayer_manager.engine_player_manager_set_action$newIndex$1_0$160({1}SC:U),R,0,0,[e]
...
S:Lplayer_manager.engine_player_manager_horz$deltaX$1_0$171({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_horz$po$1_0$172({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_vert$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_vert$deltaY$1_0$173({2}SI:S),B,1,4
S:Lplayer_manager.engine_player_manager_vert$po$1_0$174({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_bounds$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_bounds$deltaY$1_0$175({2}SI:S),B,1,4
S:Lplayer_manager.engine_player_manager_bounds$posnY$1_0$175({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_bounds$invincible$1_0$175({1}SC:U),B,1,7
S:Lplayer_manager.engine_player_manager_bounds$po$1_0$176({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_collision$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_collision$state$1_0$181({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_collision$lookX$1_0$181({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_collision$tileY$1_0$181({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_collision$deltaY$1_0$181({2}SI:S),B,1,7
S:Lplayer_manager.engine_player_manager_collision$posnY$1_0$181({1}SC:U),B,1,9
S:Lplayer_manager.engine_player_manager_collision$invincible$1_0$181({1}SC:U),B,1,10
S:Lplayer_manager.engine_player_manager_collision$po$1_0$182({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_collision$player_state$1_0$182({1}SC:U),R,0,0,[c]
S:Lplayer_manager.engine_player_manager_collision$collision$1_0$182({1}SC:S),B,1,-1
...
S:Lplayer_manager.engine_player_manager_animate$frame$1_0$193({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_animate$po$1_0$194({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_dying$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_dying$po$1_0$197({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_finish$0_0$0({2}DF,SC:U),Z,0,2,0,0,0
S:Lplayer_manager.engine_player_manager_finish$po$1_0$198({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_finish$player_begY$1_0$198({1}SC:U),B,1,-4
S:Lplayer_manager.engine_player_manager_finish$player_endY$1_0$198({1}SC:U),B,1,-3
...
S:Lplayer_manager.updatePlayerX$po$1_0$202({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerY$po$1_0$203({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerFrameGroundToFlying$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerFrameGroundToFlying$player_frame$1_0$204({1}SC:U),B,1,4
F:Fplayer_manager$updatePlayerFrameFlyingToGround$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerFrameFlyingToGround$player_frame$1_0$207({1}SC:U),B,1,4
F:G$engine_player_manager_pass$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_pass$player_passX$1_0$210({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_pass$player_endY$1_0$210({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_pass$po$1_0$211({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_pass$deltaY$1_0$211({2}SI:S),R,0,0,[e,d]
F:G$engine_player_manager_pass_frame$0_0$0({2}DF,SV:S),Z,0,-1,0,0,0
S:Lplayer_manager.engine_player_manager_pass_frame$po$1_0$215({2}DG,STtag_struct_player_object:S),R,0,0,[]
...
S:Lplayer_manager.engine_player_manager_dead$player_deadX$1_0$216({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_dead$po$1_0$217({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_dead$deltaY$1_0$217({2}SI:S),R,0,0,[l,h]
F:G$engine_player_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_draw$po$1_0$221({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_draw$deltaDraw$1_0$221({1}SC:U),R,0,0,[e]
...
S:Lplayer_manager.engine_player_manager_head$po$1_0$222({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_head$index$1_0$222({1}SC:U),R,0,0,[c]
