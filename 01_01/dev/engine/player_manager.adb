...
S:Lplayer_manager.engine_player_manager_init$po$1_0$140({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_initX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_initX$difficulty$1_0$141({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_initX$world$1_0$141({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_initX$po$1_0$142({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_loadX$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadX$checkScreen$1_0$143({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadX$po$1_0$144({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_loadX$offset$1_0$144({2}SI:U),R,0,0,[c,b]
F:G$engine_player_manager_loadY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_loadY$player_loadY$1_0$145({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_loadY$po$1_0$146({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_lives$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_lives$difficulty$1_0$149({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_lives$po$1_0$150({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_get_deltaX$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_get_deltaX$state$1_0$152({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_get_deltaX$command$1_0$152({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_get_deltaX$po$1_0$153({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_get_deltaX$deltaX$1_0$153({1}SC:U),R,0,0,[c]
F:G$engine_player_manager_get_deltaY$0_0$0({2}DF,SI:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_get_deltaY$po$1_0$158({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_get_deltaY$deltaY$1_0$158({2}SI:S),R,0,0,[e,d]
...
S:Lplayer_manager.engine_player_manager_set_action$frame$1_0$161({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_set_action$command$1_0$161({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_set_action$po$1_0$162({2}DG,STtag_struct_player_object:S),R,0,0,[c,b]
S:Lplayer_manager.engine_player_manager_set_action$newFrame$1_0$162({1}SC:U),B,1,-1
S:Lplayer_manager.engine_player_manager_set_action$newIndex$1_0$162({1}SC:U),R,0,0,[e]
...
S:Lplayer_manager.engine_player_manager_horz$deltaX$1_0$173({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_horz$po$1_0$174({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_vert$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_vert$deltaY$1_0$175({2}SI:S),B,1,4
S:Lplayer_manager.engine_player_manager_vert$po$1_0$176({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_bounds$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_bounds$deltaY$1_0$177({2}SI:S),B,1,4
S:Lplayer_manager.engine_player_manager_bounds$posnY$1_0$177({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_bounds$invincible$1_0$177({1}SC:U),B,1,7
S:Lplayer_manager.engine_player_manager_bounds$po$1_0$178({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_collision$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_collision$state$1_0$183({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_collision$lookX$1_0$183({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_collision$tileY$1_0$183({1}SC:U),B,1,6
S:Lplayer_manager.engine_player_manager_collision$deltaY$1_0$183({2}SI:S),B,1,7
S:Lplayer_manager.engine_player_manager_collision$posnY$1_0$183({1}SC:U),B,1,9
S:Lplayer_manager.engine_player_manager_collision$invincible$1_0$183({1}SC:U),B,1,10
S:Lplayer_manager.engine_player_manager_collision$po$1_0$184({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_collision$player_state$1_0$184({1}SC:U),R,0,0,[c]
S:Lplayer_manager.engine_player_manager_collision$collision$1_0$184({1}SC:S),B,1,-1
...
S:Lplayer_manager.engine_player_manager_animate$frame$1_0$195({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_animate$po$1_0$196({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_dying$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_dying$po$1_0$199({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:G$engine_player_manager_finish$0_0$0({2}DF,SC:U),Z,0,2,0,0,0
S:Lplayer_manager.engine_player_manager_finish$po$1_0$200({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_finish$player_begY$1_0$200({1}SC:U),B,1,-4
S:Lplayer_manager.engine_player_manager_finish$player_endY$1_0$200({1}SC:U),B,1,-3
...
S:Lplayer_manager.updatePlayerX$po$1_0$204({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerY$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerY$po$1_0$205({2}DG,STtag_struct_player_object:S),R,0,0,[]
F:Fplayer_manager$updatePlayerFrameGroundToFlying$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerFrameGroundToFlying$player_frame$1_0$206({1}SC:U),B,1,4
F:Fplayer_manager$updatePlayerFrameFlyingToGround$0_0$0({2}DF,SC:U),Z,0,0,0,0,0
S:Lplayer_manager.updatePlayerFrameFlyingToGround$player_frame$1_0$209({1}SC:U),B,1,4
F:G$engine_player_manager_pass$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_pass$player_passX$1_0$212({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_pass$player_endY$1_0$212({1}SC:U),B,1,5
S:Lplayer_manager.engine_player_manager_pass$po$1_0$213({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_pass$deltaY$1_0$213({2}SI:S),R,0,0,[e,d]
F:G$engine_player_manager_pass_frame$0_0$0({2}DF,SV:S),Z,0,-1,0,0,0
S:Lplayer_manager.engine_player_manager_pass_frame$po$1_0$217({2}DG,STtag_struct_player_object:S),R,0,0,[]
...
S:Lplayer_manager.engine_player_manager_dead$player_deadX$1_0$218({1}SC:U),B,1,4
S:Lplayer_manager.engine_player_manager_dead$po$1_0$219({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_dead$deltaY$1_0$219({2}SI:S),R,0,0,[l,h]
F:G$engine_player_manager_count$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$engine_player_manager_right$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_right$deltaX$1_0$225({1}SC:U),B,1,4
F:G$engine_player_manager_down$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_down$deltaY$1_0$227({1}SC:S),B,1,4
F:G$engine_player_manager_draw$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lplayer_manager.engine_player_manager_draw$po$1_0$229({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_draw$deltaDraw$1_0$229({1}SC:U),R,0,0,[e]
...
S:Lplayer_manager.engine_player_manager_head$po$1_0$230({2}DG,STtag_struct_player_object:S),R,0,0,[]
S:Lplayer_manager.engine_player_manager_head$index$1_0$230({1}SC:U),R,0,0,[c]
