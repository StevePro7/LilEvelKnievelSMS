...
S:Llevel_manager.engine_level_manager_init$sloc0$0_1$0({2}DG,SC:U),B,1,-2
F:G$engine_level_manager_draw_screen$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llevel_manager.engine_level_manager_draw_screen$checkScreen$1_0$100({1}SC:U),B,1,4
S:Llevel_manager.engine_level_manager_draw_screen$lo$1_0$101({2}DG,STtag_struct_level_object:S),R,0,0,[]
S:Llevel_manager.engine_level_manager_draw_screen$scrollColumn$1_0$101({2}SI:U),R,0,0,[c,b]
S:Llevel_manager.engine_level_manager_draw_screen$index$1_0$101({1}SC:U),R,0,0,[e]
...
S:Llevel_manager.engine_level_manager_draw_column$level_data$1_0$105({1}SC:U),R,0,0,[c]
S:Llevel_manager.engine_level_manager_draw_column$level_column$1_0$105({1}SC:U),B,1,-2
S:Llevel_manager.engine_level_manager_draw_column$level_object$1_0$105({1}SC:U),B,1,-1
S:Llevel_manager.engine_level_manager_draw_column$level_platform$1_0$105({1}SC:U),R,0,0,[c]
S:Llevel_manager.engine_level_manager_draw_column$flip$1_0$105({1}:S),R,0,0,[b]
