...
F:G$engine_riff_manager_loop$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lriff_manager.engine_riff_manager_loop$index$1_0$87({1}SC:U),B,1,4
S:Lriff_manager.engine_riff_manager_loop$loops$1_0$88({1}SC:U),R,0,0,[e]
S:Lriff_manager.engine_riff_manager_loop$count$1_0$88({1}SC:U),R,0,0,[b]
S:Lriff_manager.engine_riff_manager_loop$value$1_0$88({1}SC:U),R,0,0,[c]
F:G$engine_riff_manager_play$0_0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Lriff_manager.engine_riff_manager_play$index$1_0$91({1}SC:U),B,1,4
S:Lriff_manager.engine_riff_manager_play$ho$1_0$92({2}DG,STtag_struct_hack_object:S),R,0,0,[]
S:Lriff_manager.engine_riff_manager_play$data$1_0$92({2}DG,SC:U),R,0,0,[e,d]
